...
// A los recorridos de 2012, les agrega el valor de distancia en metros
...
$query = "SELECT recorridos_bici_2012.recorridoid, estaciones_distancia.distancia 
		  FROM recorridos_bici_2012 
		  INNER JOIN estaciones_distancia 
		  ON recorridos_bici_2012.origenestacion = estaciones_distancia.origen_estacion_id 
		  AND recorridos_bici_2012.destinoestacion = estaciones_distancia.destino_estacion_id"; 

$result = mysql_query($query) or die(mysql_error());

// Para cada recorrido, agregar distancia del recorrido a partir del join anterior
while($row = mysql_fetch_array($result)){
	$update_query = "UPDATE recorridos_bici_2012 SET distanciametros = " . $row['distancia'] . " WHERE recorridoid = " . $row['recorridoid'] . ";";
